 ...
 */
public class BillboardControllerOld {
    private UserModel userModel;
    private BillboardView billboardView;
    private AppFrame frame;
    private BillboardModelOld model;
    private MainNav mainNav;
    private String imageName;

    public BillboardControllerOld(AppFrame frame, BillboardModelOld model, BillboardView billboardView, MainNav mainNav, UserModel userModel) {
        this.frame = frame;
        this.model = model;
