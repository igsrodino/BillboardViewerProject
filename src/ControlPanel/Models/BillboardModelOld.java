...
public class BillboardModelOld {
    ...
    /**
     * Saves the current billboard to the local array
     */
    public void saveCurrentBillboardLocal(BillboardPOJO bb){
        this.billboards.set(this.currentBillboardIndex, bb);
    }
    ...
    public BillboardPOJO getBillboardPOJO(int selectedIndex) {
        ...
        this.currentBillboardIndex = idx;
        return this.billboards.get(idx);
    }
